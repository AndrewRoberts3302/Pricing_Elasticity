...
from i_shares_product_level import product_share
from j_shares_class_level import class_share
from k_shares_group_level import group_share
...
shares.to_csv(data_path / "qc_shares.csv", index=False)
