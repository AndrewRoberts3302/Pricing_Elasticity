...
from d_remove_outliers_quantity import df

print("\nThe head of the data after quantity cleaning is:\n", df.head(2), "\n")

# Check the shape of the data before removing outliers.
print("\nThe shape of df before removing outliers based on value is:\n", df.shape, "\n")
...
print("\nThe shape of df after removing outliers based on value is:\n", df.shape, "\n")
print("\nThe head of df after removing outliers based on value is:\n\n", df.head(2))
