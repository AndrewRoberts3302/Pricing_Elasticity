...
from g_apply_price_diff_bands import df
...
# ros = ros.reset_index()
#
# ros = ros.rename(columns={"outlet": "outlet_count"})
#
# ros["quantity_ros"] = ros["quantity"] / ros["outlet_count"]
# ros["value_ros"] = ros["value"] / ros["outlet_count"]
#
# ros = ros[[
#     "date", "market", "product", "uom", "price_vs_control_band", "quantity_ros", "value_ros", "outlet_count"
#     ]]
#
# # Average Ros
# ros_avg = df.groupby(
...
#
# ros_avg = ros_avg.rename(columns={"outlet": "total_outlet_count"})
#
...
#
# ros_avg = ros_avg[[
#     "date", "market", "product", "uom", "avg_quantity_ros", "avg_value_ros", "total_outlet_count"
#     ]]
#
...
ros = ros[[
    "date", "market", "product", "uom", "price_vs_control_band", "quantity_ros", "value_ros", "outlet_count", "operator_count"
    ]]
...
# Export Ros for QC
ros.to_csv(data_path / "qc_ros_vs_index_control.csv", index=False)
